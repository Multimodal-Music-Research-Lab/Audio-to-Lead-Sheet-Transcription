...
> test split with pre-computed features is provided so that all results can be
> inspected and reproduced without the audio. Data is released under
...
[![Static Badge](https://img.shields.io/badge/paper-under_review-%23b31b1b?logo=arxiv)](#)
...
Public release of our audio-to-lead-sheet transcription research. From singing-voice
audio, the models transcribe a Humdrum `**kern` lead sheet with three spines:
